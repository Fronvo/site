...
<div id='appMain'>
    ...
    <div id='appPostLogin' class='full' style='display: none;'>
        ...
        <!-- Menu -->
        <div transition:fly={{y: -100, duration: 750}} class='fronvo-top-panel'>
        ...
        <!-- Panels -->
        <div in:scale={{duration: 750, start: 0.95}} out:scale={{start: 0.95, duration: 600}}>

            <!-- Chat -->
            <div class='fronvo-panel panel-1'>
            ...
            <!-- Friends -->
            <div class='fronvo-panel panel-2'>
                <svg version="1.2" baseProfile="tiny-ps" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48">
                    <defs>
