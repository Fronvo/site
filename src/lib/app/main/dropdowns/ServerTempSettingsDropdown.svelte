<script lang="ts">
    ...
    function copyInvite(): void {
        navigator.clipboard.writeText($tempCurrentServer.invite);
    }
    ...
    function toggleInvites(): void {
        ...
        // Owner only
        $tempCurrentServer.invitesDisabled =
            !$tempCurrentServer.invitesDisabled;
    }
...
<DropdownTemplateDarken>
    {#if !$tempCurrentServer?.invitesDisabled && $ourData.friends.length != 0}
    ...
    {#if $tempCurrentServer?.ownerId == $ourData.profileId}
        ...
        <button on:click={toggleInvites}
            ><h1>
                {$tempCurrentServer?.invitesDisabled ? 'Enable' : 'Disable'} invite
            </h1>
            {#if !$tempCurrentServer?.invitesDisabled}
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
                    height="32"
