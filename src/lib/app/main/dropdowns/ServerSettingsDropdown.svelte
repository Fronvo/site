<script lang="ts">
    ...
    function showBanned(): void {
        showModal(ModalTypes.BannedMembers);
    }
...
<DropdownTemplateDarken>
    ...
    {#if $currentServer?.ownerId == $ourData.profileId && $currentServer?.bannedMembers.length > 0}
        <button on:click={showBanned}
